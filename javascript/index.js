...
// ---------using the callbacks function to print the cooking steps to make Mashed Potatoes in the correct order----------------. 
    ...
    getInstruction("mashedPotatoes", 2, (step3) => {
      ...
      getInstruction("mashedPotatoes", 3, (step4) => {
        ...
        getInstruction("mashedPotatoes", 4, (step5) => {
          ...
          document.querySelector("#mashedPotatoes").innerHTML += `<li>Mashed potatoes are going to be ready!</li>`;
...
// making the obtainInstruction as the fuction using promises having two arguments( resolve, reject)
...
// ...When using await always remember to add the keyword async to the enclosing function. 
